        ...
        <aside class="sidebar">
            ...
            <nav>
                <ul>
                    ...
                    <li><a href="schedule.html" class="active">
        ...
        <main class="main-content">
            ...
            <div class="content-wrapper">
                <div class="calendar-header">
                    <h2>August 2025</h2>
                    <p>Select your available date</p>
                </div>
                <div class="calendar-grid">
                    ...
                    <div class="date active">29</div>
                    <div class="date active">30</div>
                    <div class="date active">31</div>
                    <div class="date active">1</div>
                    <div class="date disabled">2</div>
                    <div class="date disabled">3</div>
                    ...
                    <div class="date disabled">9</div>
                    <div class="date disabled">10</div>
                    <div class="date active">11</div>
                    <div class="date disabled">12</div>
                    <div class="date active">13</div>
                    <div class="date active">14</div>
                    <div class="date active">15</div>
                    <div class="date disabled">16</div>
                    <div class="date disabled">17</div>
                    <div class="date active">18</div>
                    <div class="date active">19</div>
                    <div class="date disabled">20</div>
                    <div class="date active">21</div>
                    <div class="date active">22</div>
                    <div class="date disabled">23</div>
                    <div class="date disabled">24</div>
                    <div class="date active">25</div>
                    <div class="date active">26</div>
                    <div class="date disabled">27</div>
                    <div class="date active">28</div>
                    <div class="date active">29</div>
                    <div class="date disabled">30</div>
                    <div class="date disabled">31</div>
                </div>
