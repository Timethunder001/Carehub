...
<head>
    ...
    <title>CareHub - Assign Elderly</title>
    ...
    <div class="container">
            ...
            <nav>
                <ul>
                    ...
                    <li><a href="schedule.html">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M8 7V3M16 7V3M3 11H21M5 21H19C20.1046 21 21 20.1046 21 19V7C21 5.89543 20.1046 5 19 5H5C3.89543 5 3 5.89543 3 7V19C3 20.1046 3.89543 21 5 21Z" stroke="#333" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>
                        Schedule
                    </a></li>
                    <li><a href="assign-elderly.html" class="active">
        ...
        <main class="main-content">
            ...
            <div class="content-wrapper">
                <div class="assign-elderly-grid">
                    <div class="card profile-card">
                        <div class="avatar"></div>
                        <div class="info-grid">
                            <div class="info-group">
                                <span>Name: <strong>Emily Cr.</strong></span>
                                <span>Age: <strong>65</strong></span>
                                <span>Gender: <strong>Female</strong></span>
                            </div>
                            <div class="info-group">
                                <span>Date of Birth: <strong>17 Oct 1960</strong></span>
                                <span>Status: <strong>Post-operative support</strong></span>
                                <span>Address: <strong>Unit 86 456 Vincent St.</strong></span>
                            </div>
                        </div>
                    </div>
                    <div class="card emergency-contact">
                        <h3 class="card-header">Emergency Contact</h3>
                        <p>Name: <strong>David Smith</strong></p>
                        <p>Relation: <strong>Son</strong></p>
                        <button class="btn call-btn">Call Now 📞</button>
                    </div>
                    <div class="card medication-schedule">
                         <h3 class="card-header">Medication Schedule</h3>
                         <ul>
                            <li><span>8:00 am</span><span>Metformin</span><span>500mg</span></li>
                            <li><span>12:00 pm</span><span>Panadol</span><span>800mg</span></li>
                            <li><span>1:00 pm</span><span>Ozempic</span><span>400mg</span></li>
                            <li><span>5:00 pm</span><span>Rapamycin</span><span>300mg</span></li>
                         </ul>
                    </div>
                    ...
                    <div class="card upcoming-appointments">
                        <h3 class="card-header">Upcoming Appointments</h3>
                        <ul>
                            <li class="appointment">
                                <div class="icon">➕</div>
                                <div>
                                    <strong>21 August<br>2:30 PM</strong>
                                    <p>Heart check-up</p>
                                </div>
                            </li>
                            <li class="appointment">
                                <div class="icon">💉</div>
                                <div>
                                    <strong>29 August<br>4:30 PM</strong>
                                    <p>Boost Vaccine</p>
                                </div>
                            </li>
                        </ul>
