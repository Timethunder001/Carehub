...
<head>
    ...
    <title>CareHub - Update Care</title>
        ...
        <aside class="sidebar">
            ...
            <nav>
                <ul>
                    ...
                    <li><a href="update-care.html" class="active">
            ...
            <div class="content-wrapper">
                <form class="update-care-form">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="message" name="message" placeholder="Type your update here..."></textarea>
                    </div>
