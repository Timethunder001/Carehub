...
<head>
    ...
    <title>CareHub - Assign Staff</title>
        ...
        <aside class="sidebar">
            ...
            <nav>
                <ul>
                    ...
                    <li><a href="assign-staff.php" class="active">
        ...
        <main class="main-content">
            ...
            <div class="content-wrapper">
                <div class="card schedule-card">
                    <h2 class="card-header">Carer Lists</h2>
                                    ...
                                    <?php foreach ($carers as $carer): ?>
                                        ...
                                        if (count($assignments) > 0): ?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <form method="POST" action="assign-staff.php" style="display: inline;">
                                        ...
                                        <?php else: ?>
                                            ...
                                            <tr>
                                                <form method="POST" action="assign-staff.php" class="assignment-form">
                                                    <td>
